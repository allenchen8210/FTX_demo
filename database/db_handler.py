...
# 插入 data
#sql = "INSERT INTO user_info (dc_id, api_key, secret_key) VALUES (%s, %s, %s)"
#val = ("547083804150464513", "E1XYXeh2iNzzBvuoKZtuELlRSpxw8LmBDcVKuD5Z", "RqHYRiaLtoZ3EoQkcKGR4uGjCoX1Xf25yUb0wEpD")
...
class DBHandler():
    ...
    def get_user_info(self):
        ...
        for row in result:
            ...
            user_data["market_info"] = json.loads(row[4])
    ...
    def set_market_info_amount(self, id, market, params):
